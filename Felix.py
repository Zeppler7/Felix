...
def wish_user():
    ...
    fun_talk("I am Felix. Tell me how may I help you.")
    ...
    while True: 
        ...
        if 'wikipedia' in query:
           ...
           file.close
            ...
            webbrowser.open("bit-bangalore.edu.in/")
            ...
            fun_talk("I am Felix, developed by Sanjana and Vignesh.")
            ...
            email_list = {
                'Vignesh': 'vignesh945891@gmail.com',
                'Sanjana': 'sanjana123@gmail.com',
            ...
            def get_mail_info():
                ...
                if name not in email_list:
                    fun_talk("Sorry I don't know the email. Please type in.")
                    e=get_command()
                    email_list[name]=e
            ...
            try:
                ...
                fun_talk("Specify from and to currencies for currency conversions")
                from_cur,to_cur = get_command().split
